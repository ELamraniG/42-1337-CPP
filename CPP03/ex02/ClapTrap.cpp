...
{
	std::cout << "clap trap name const called" << std::endl;
}
ClapTrap::~ClapTrap()
{
	std::cout << "clap trap default deconst called" << std::endl;
}
ClapTrap::ClapTrap(const ClapTrap &cpy)
{
	std::cout << "clap trap copy const called, from: " << cpy.name << std::endl;
	*this = cpy;
}
ClapTrap &ClapTrap::operator=(const ClapTrap &cpy)
{
	std::cout << "clap trap copy assignment called, from: " << cpy.name << std::endl;
